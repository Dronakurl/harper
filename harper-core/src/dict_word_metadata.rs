...
pub struct DictWordMetadata {
    ...
    /// Inflectional features (case, gender, number, mood) used by the non-English
    /// language modules. English never sets this, and the field does not exist at
    /// all unless a language module is compiled in.
    ///
    /// See `crate::language::morphology` for the definition and accessors.
...
impl DictWordMetadata {
    ...
    pub fn merge(&mut self, other: &Self) -> &mut Self {
        ...
        #[cfg(feature = "language-module")]
        {
            self.morphology = merge!(self.morphology, other.morphology);
        }
