...
use crate::language::dialects::dialect_trait::{Dialect, DialectFlags as DialectFlagsTrait};
...
impl DialectFlagsTrait<EnglishDialect> for EnglishDialectFlags {
