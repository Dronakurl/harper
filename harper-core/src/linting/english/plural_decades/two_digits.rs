...
mod lints {
    ...
    fn dont_flag_one_digit() {
        assert_no_lints(
            "0's doesn't look like a decade",
            PluralDecades::default(),
            crate::languages::LanguageFamily::English,
        );
    }
    ...
    fn dont_flag_hyphenated_version_numbers_soi_20() {
        assert_no_lints(
            "View soi-20's full-sized avatar.",
            PluralDecades::default(),
            crate::languages::LanguageFamily::English,
        );
    }
