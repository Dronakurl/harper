...
use super::german_noun_capitalization::GermanNounCapitalization;
use super::german_sentence_capitalization::GermanSentenceCapitalization;
use super::german_spell_check::GermanSpellCheck;
...
use crate::linting::{
    be_adjective_confusions, closed_compounds, german_weir_rules, initialisms,
    phrase_set_corrections, weir_rules,
};
...
impl LintGroup {
    ...
    pub fn new_curated(dictionary: Arc<impl Dictionary + 'static>, dialect: Dialect) -> Self {
        ...
        // Language-universal rules (typography, formatting, structure)
        insert_struct_rule!(Dashes, true);
        ...
        if dialect.is_german() {
            ...
            // German grammar and style rules (Weir-based)
            out.merge_from(german_weir_rules::lint_group());
        } else {
            // English-specific rules (grammar, spelling, style)
